...
> **Repositorio:** el código de la aplicación está en la carpeta [`integradora/`](integradora/) y el plan de desarrollo en [`PLAN_DESARROLLO.md`](PLAN_DESARROLLO.md).
...
![Inicio](integradora/docs/capturas/01-inicio.jpg)
...
└── integradora/docs/capturas/               Capturas de pantalla
```
...
![Validaciones](integradora/docs/capturas/03-validaciones-js.jpg)
...
|---|---|
| ![Formulario](integradora/docs/capturas/02-formulario.jpg) | ![Eventos](integradora/docs/capturas/04-eventos.jpg) |

| Búsqueda con filtros | Bitácora de auditoría |
|---|---|
| ![Búsqueda](integradora/docs/capturas/05-busqueda.jpg) | ![Bitácora](integradora/docs/capturas/06-bitacora.jpg) |
